...
class TimeTrackingClientTests(SimpleTestCase):
    ...
    def test_update_time_entry_raises_error_on_invalid_response_schema(self):
        """Test update_time_entry raises TimeTrackingServiceError on invalid response schema."""
        user_id = 123
        time_entry_id = 10
    ...
    def test_delete_time_entry_sends_user_id_header(self):
        """Test delete_time_entry sends X-User-ID header."""
        user_id = 123
        time_entry_id = 10
        ...
        delete_time_entry(user_id=user_id, time_entry_id=time_entry_id)
    ...
    def test_delete_time_entry_raises_service_unavailable_on_request_exception(self):
        """Test delete_time_entry raises TimeTrackingServiceUnavailable on request exception."""
        user_id = 123
        time_entry_id = 10
    ...
    def test_delete_time_entry_raises_error_on_non_2xx_response(self):
        """Test delete_time_entry raises TimeTrackingServiceError on 4xx/5xx response."""
        user_id = 123
        time_entry_id = 10

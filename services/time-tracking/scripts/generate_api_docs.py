...
OPENAPI_URL = "http://localhost:5001/openapi.json"
OPENAPI_PATH = Path("services/time-tracking/docs/openapi.json")
MARKDOWN_PATH = Path("services/time-tracking/docs/API.md")
...
def fetch_openapi_spec():
    ...
    try:
        ...
        raise RuntimeError(
            ...
            f"Tried: {OPENAPI_URL}\n\n"
            "Make sure the time-tracking Flask container is running and that the port is exposed.\n\n"
            "Example:\n"
            "  docker compose up time-tracking\n\n"
            "Then try again:\n"
